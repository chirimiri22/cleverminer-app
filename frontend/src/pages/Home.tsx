      ...
      <Container sx={{ flexGrow: 1, py: 4 }}>
        ...
        <Paper elevation={0} sx={{ mt: 6, p: 3, border: "1px solid #ddd", borderRadius: 0 }}>
          ...
          <Box sx={{ display: "flex", alignItems: "center", mt: 2 }}>
            ...
            <Typography variant="body1">Observe the data structure</Typography>
          </Box>
          <Box sx={{ display: "flex", alignItems: "center", mt: 2 }}>
            <Box sx={{ mr: 3 }}>
              <span className="material-icons" style={{ fontSize: 40, color: "#666" }}>
            ...
            <Typography variant="body1">Set the task to find interesting patterns</Typography>
          </Box>
          <Box sx={{ display: "flex", alignItems: "center", mt: 2 }}>
            <Box sx={{ mr: 3 }}>
              <span className="material-icons" style={{ fontSize: 40, color: "#666" }}>
            ...
            <Typography variant="body1">Examine results in a user-friendly format</Typography>
          </Box>
          <Box sx={{ display: "flex", alignItems: "center", mt: 2 }}>
            <Box sx={{ mr: 3 }}>
              <span className="material-icons" style={{ fontSize: 40, color: "#666" }}>
            ...
            <Typography variant="body1">Export results in a machine-readable format</Typography>
          </Box>
        </Paper>
      </Container>
      <Divider />
